...
/// ## Overview
///
/// UniversalTemplate is the foundation of infinite recursive modularity. Every component,
...
/// └── Documentation/
///     └── UniversalTemplate.docc/      # Swift DocC documentation
/// ```
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "UniversalTemplate",
            dependencies: [],
            path: "Sources/UniversalTemplate",
            swiftSettings: [
        ...
        // Test target
        .testTarget(
            name: "UniversalTemplateTests",
            dependencies: [
                "UniversalTemplate",
                .product(name: "Testing", package: "swift-testing")
            ],
            path: "Tests/UniversalTemplateTests"
        )
    ]
)
