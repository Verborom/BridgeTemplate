...
/// ## Overview
///
/// VoiceCommands is the foundation of infinite recursive modularity. Every component,
...
/// └── Documentation/
///     └── VoiceCommands.docc/      # Swift DocC documentation
/// ```
let package = Package(
    name: "VoiceCommands",
    platforms: [
    ...
    targets: [
        ...
        // Test target
        .testTarget(
            name: "VoiceCommandsTests",
            dependencies: [
                "VoiceCommands",
                .product(name: "Testing", package: "swift-testing")
            ],
            path: "Tests/VoiceCommandsTests"
        )
    ]
)
